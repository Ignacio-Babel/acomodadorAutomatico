...
public class MenuService implements IMenuService {
	...
	public void printCurrentStaceCinema(List<SeatOfAvailableGroups> firstAvailableSeats) {
		System.out.println("this is the first seats" + firstAvailableSeats);
		...
		SeatOfAvailableGroups firstGroup = firstAvailableSeats.isEmpty() ? null : firstAvailableSeats.get(0);
